...
//        }
    ...
    func testComposition() {
        ...
        let fonts: [String: BONFont] = attributedString.rangesFor(attribute: convertFromNSAttributedStringKey(NSAttributedString.Key.font))
    ...
    func testHTMLish() {
        ...
        let actualFonts: [String: BONFont] = attributedString.rangesFor(attribute: convertFromNSAttributedStringKey(NSAttributedString.Key.font))
        XCTAssertEqual(expectedFonts, actualFonts)
        XCTAssertEqual(["5:4": URL(string: "http://raizlabs.com/")!], attributedString.rangesFor(attribute: convertFromNSAttributedStringKey(NSAttributedString.Key.link)))
    }
